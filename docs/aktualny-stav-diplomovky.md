...
| `manuscript/20_introduction.md` | `silný draft` | prepracovaný podľa rozšíreného draftu: 1.1 depresívna symptomatika, 1.2 klasické simulované patienty, 1.3 LLM simulovaní pacienti (CureFun, PATIENT-ψ, Adaptive-VP, MindVoyager), 1.4 expertná evaluácia + COSMIN, 1.5 pojmový rámec s operacionalizáciou `guardrail` a `profile`, 1.6 výskumná medzera, 1.7 cieľ/VO1-VO8/H1-H9 (jadro H1-H5, rozšírené H6-H9) | 6 placeholder citekeys (`who2025depression`, `chaby2022embodiedvirtualpatients`, `li2024curefun`, `wang2024patientpsi`, `lee2025adaptivevp`, `kim2025mindvoyager`) čaká na import do Zotera (backlog `B22`); potom evidence-anchored výpisky (`B23`) |
...
| Nové literárne medzery F-I (6 zdrojov z rozšíreného Úvodu) | `chýba` | finalizáciu Úvodu so živými Zotero citáciami | `who2025depression`, `chaby2022embodiedvirtualpatients`, `li2024curefun`, `wang2024patientpsi`, `lee2025adaptivevp`, `kim2025mindvoyager` sú placeholdery v `manuscript/20_introduction.md`; viď `docs/literature/gaps_and_missing_sources.md` a backlog `B22`, `B23` |
...
- importovať 6 nových zdrojov z rozšíreného Úvodu do Zotera (gaps F-I) a potvrdiť citekeys `who2025depression`, `chaby2022embodiedvirtualpatients`, `li2024curefun`, `wang2024patientpsi`, `lee2025adaptivevp`, `kim2025mindvoyager` podľa backlog `B22`
