...
| B24 | `P2` | `in_progress` | Zapracovať vzdelávací a platformový framing práce do Úvodu, Diskusie a obhajoby | konzultačné usmernenie školiteľky, note `notes/meetings/2026-04-08-skolitelka-vzdelavaci-framing-plan.md`, sesterský repozitár `../ai-patient-sim` | čisté formulácie pre praktický prínos práce, väzba na psychologické vzdelávanie, argument že `ai-patient-sim` / Chat Lab je kontrolovaná simulačná platforma a nie len jednorazový prompt experiment |
...
3. `B24` pretaviť do konkrétnych úprav v `20_introduction.md`, `50_discussion.md` a podkladov na obhajobu.
