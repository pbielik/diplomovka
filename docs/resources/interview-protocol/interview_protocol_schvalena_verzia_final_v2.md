# Interview protocol - schválená verzia

Status: schválená finálna verzia interview packu.

Účel: pracovný interviewer sheet pre všetky vetvy rozhovorov s prehľadom hlavných otázok, doplňujúcich otázok a záverečného PHQ-9 bloku.

Poznámka: obsahovo ide o schválenú verziu otázok. Markdown verzia je technicky vyčistený prepis pôvodného `.docx`, aby sa s dokumentom dalo ďalej pracovať v repozitári.
...
Používanie: najprv krátke otvorenie, potom blok A1 - A9 podľa toku reči pacienta a až na záver štandardizovaný PHQ-9 dodatok.
...
Poradie domén A1 - A9 je možné meniť podľa toku reči pacienta. Na každú doménu použite maximálne jednu doplňujúcu otázku.
...
- Poznámka: Ak pacient uvedie plán alebo zámer, okamžite prejdite na Prílohu F - Bezpečnostný protokol.
...
Bezpečnostná poznámka: Ak sa pri položke 9 objaví plán, zámer alebo bezprostredné riziko, prerušte štandardný priebeh a pokračujte podľa Prílohy F - Bezpečnostný protokol.
...
- [ ] Poradie domén prispôsobujem toku reči pacienta, nie rigidnému poradovníku.
