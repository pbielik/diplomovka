    ...
    tasks: list[AgentTask] = [
        ...
        AgentTask(
            ...
            user_input=(
                ...
                "SUPPORTING TABLE 4:\n"
                f"{trim_text(preview_table_4, 5000) or '(preview table 4 missing)'}\n\n"
                "SUPPORTING TABLE 5:\n"
                f"{trim_text(preview_table_5, 5000) or '(preview table 5 missing)'}\n\n"
                "SUPPORTING TABLE 6:\n"
                f"{trim_text(preview_table_6, 7000) or '(preview table 6 missing)'}\n\n"
                "SUPPORTING TABLE 7A:\n"
                f"{trim_text(preview_table_7a, 5000) or '(preview table 7A missing)'}\n\n"
                "SUPPORTING TABLE 7B:\n"
                f"{trim_text(preview_table_7b, 4000) or '(preview table 7B missing)'}\n\n"
                "SUPPORTING TABLE 10:\n"
                f"{trim_text(preview_table_10, 5000) or '(preview table 10 missing)'}\n\n"
