...
Nižšia hodnota týchto ukazovateľov znamená vyššiu presnosť zhody rozhovoru s cieľovým seed scenárom. Priemerná absolútna chyba v symptomatických doménach slúži prednostne ako transcript-level fidelity ukazovateľ; expertne hodnotené severity a functional impact položky dopĺňajú tento pohľad o samostatnú ľudskú vrstvu. V kombinácii s indexom klinickej vierohodnosti tak možno odlíšiť „vyzerá dobre na povrchu" od „zodpovedá zamýšľanému klinickému obrazu".
...
**VO2.** Do akej miery sú AI-generované simulované klinické interview symptomaticky primerané vzhľadom na cieľový seed scenár, z ktorého vychádzajú, a to na úrovni transcript-level PHQ-9 profilov A1 až A9 aj na úrovni expertných odhadov S1 a S2?
...
**VO4.** Aký vzťah má štýl odpovedania simulovaného pacienta k symptomatickej primeranosti interview a k výskytu varovných signálov, a to na úrovni transcript-level symptom fidelity, expertných odhadov závažnosti a funkčného dopadu a indexu defektov?
...
**H4.** Interview vytvorené so štruktúrujúcim klinickým usmernením budú symptomaticky primeranejšie vzhľadom na cieľový seed scenár než interview bez tohto usmernenia. Tento predpoklad bude primárne posudzovaný cez nižšiu priemernú absolútnu chybu transcript-level symptomatických domén A1 až A9 voči seed anchorom; expertné odhady závažnosti a funkčného dopadu budú túto líniu dopĺňať ako samostatná ľudská vrstva aj cez priame `S1/S2` error ukazovatele.
...
**H6.** Interview s vyváženým alebo rozvinutým štýlom odpovedania simulovaného pacienta (P2 alebo P3) budú odbornými hodnotiteľmi posudzované ako klinicky vierohodnejšie než interview so zdržanlivým štýlom odpovedania (P1), a to na úrovni indexu klinickej vierohodnosti.
...
**H8.** Interview s rozvinutejším štýlom odpovedania (P3) budú poskytovať symptomaticky bohatší a presnejší obraz prípadu než interview so zdržanlivejším štýlom (P1), teda budú mať nižšiu priemernú absolútnu chybu transcript-level symptomatických domén A1 až A9 voči seed anchorom.
