...
Analýzy, ktoré priamo neodpovedajú na H1 až H9, budú v kapitole Výsledky explicitne označené ako doplnkové alebo exploratórne, aby sa neporušila logická väzba medzi cieľom, hypotézami a poradím prezentácie výsledkov.
